...
기상 데이터, 연료 조건, 지형 정보 등 26개 변수를 활용하여 0.1° 격자 단위로 산불 발생 확률을 예측합니다.
(원본 ECMWF 모델 19개 변수 + 한국 특화 feature engineering)
...
- **한 행 = "하루 × 격자셀"**: 예) 2019-05-12, grid #123456, 26-28 features, `af_flag=0/1`
