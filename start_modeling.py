...
def main():
    ...
    # 결과 디렉토리 생성
    model_dir = "ml_modeling/models"
    os.makedirs(model_dir, exist_ok=True)
    
    # 데이터 로드
    input_file = "ml_modeling/weather_data_with_wind.csv"
    ...
    # 피처 선택 (기본 날씨 변수 + 풍속)
    features = ['t2m', 'td2m', '10u', '10v', 'tp', 'wind10m']
    target = 'af_flag'
    ...
    print(f"특성 중요도 시각화 저장: {model_dir}/feature_importance.png")
